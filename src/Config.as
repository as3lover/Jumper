...
public class Config
{
    public static const PLANE_DISTANCE:int = 190;
    public static const LEVEL_START_X_1:Number = 40;
    public static const LEVEL_START_X_2:Number = 135;
    public static const LEVEL_DISTANCE:int = 90;
    public static const PLANE_WIDTH:int = 150;
    ...
    public static const HERO_DENSITY:Number = 1;
